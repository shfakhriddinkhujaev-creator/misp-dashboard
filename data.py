...
REGIONS = [
    ...
    ("Тошкент ш.",     "Tashkent City",   "Toshkent",                  78,  4000,  335,      "Шаҳар",     "Иқтисодий марказ, хизматлар"),
...
BLOCKS = [
    ...
    ("III", "Тадбиркорлик ва инвестициялар", 0.16, "#7C3AED"),
    ("IV",  "Инсон капитали",               0.15, "#C8922A"),
    ("V",   "Инфратузилма",                 0.12, "#EA580C"),
    ("VI",  "Молиявий инклюзивлик",         0.10, "#0F766E"),
